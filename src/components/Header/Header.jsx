    ...
    return (
        <div className={styles.header}>
            ...
            <nav className={styles.header_nav}>
                <Link to="/" className={argument&&styles.header_nav_link_underlined||styles.header_nav_link} >Accueil</Link>
                <Link to="/Apropos" className={!argument&&styles.header_nav_link_underlined||styles.header_nav_link}>A propos</Link>
            </nav>
        </div>
    );
